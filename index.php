...
new CalypsDoH\Server(
    ...
    alarmLevel: 3, // The DOMAIN_CODE level that requests should be considered alarming. See CalypsDoH.php Constants
    blockLevel: 3, // The DOMAIN_CODE level that requests should be blocked. See CalypsDoH.php Constants
    enableStats: null, // Optional boolean to disable request stats from being logged.
);